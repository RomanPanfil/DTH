...
<!--&lt;!&ndash;                    <NuxtIcon name="cross" class="filter-popup-close hidden-desktop" @click="closeFilterPopup"></NuxtIcon>&ndash;&gt;-->
<!--                    <div class="filter">-->
...
<!--                        &lt;!&ndash; Фильтр Место проведения &ndash;&gt;-->
<!--                        <div class="filter-section">-->
...
<!--                        &lt;!&ndash; Фильтр Месяц проведения &ndash;&gt;-->
<!--                        <div class="filter-section">-->
...
<!--            </div>-->
<!--            <div class="col-md-9">-->
<!--&lt;!&ndash;                <button class="filter-popup-trigger hidden-desktop ui-btn ui-btn__primary" @click="toggleFilterPopup">&ndash;&gt;-->
<!--&lt;!&ndash;                   Фильтр&ndash;&gt;-->
<!--&lt;!&ndash;                </button>&ndash;&gt;-->
...
<!--                        <div class="filter-popup-trigger hidden-desktop" @click="toggleFilterPopup">-->
<!--                            Фильтр-->
<!--                        </div>-->
...
<!--        <button class="ui-btn ui-btn__primary filter-mobile-apply">Применить</button>-->
<!--        <button class="ui-btn ui-btn__primary" @click="resetFilters">Очистить</button>-->
<!--    </div>-->
<!--</template>-->
...
<!--const filterPopupOpen = ref<boolean | string>(false);-->
